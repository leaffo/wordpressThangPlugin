<?php
$shortcode = slz_ext( 'shortcodes' )->get_shortcode( 'gallery_grid' );
...
$author   = SLZ_Com::get_user_login2id(array(), array('empty' => esc_html__( '-All Authors-', 'slz' ) ) );
$post_type = array(
	array(
		'type'        => 'dropdown',
...
$params = array(
	...
	array(
		...
		'value'       => '',
		'description' => esc_html__( 'Choose author to filter.', 'slz' ),
...
$extra_options = array(
	...
	array(
		'type'        => 'dropdown',
		'heading'     => esc_html__( 'Filter Alignment', 'slz' ),
	...
	array(
		'type'        => 'textfield',
		'heading'     => esc_html__( 'Load More Button Content', 'slz' ),
		'param_name'  => 'load_more_btn_text',
		'value'       => '',
		'description' => esc_html__( 'Enter load more button content to display.', 'slz' ),
		'group'       => esc_html__( 'Extra Options', 'slz' ),
		'dependency'  => array(
			'element'   => 'show_category_filter',
			'value'     => array( 'yes' )
