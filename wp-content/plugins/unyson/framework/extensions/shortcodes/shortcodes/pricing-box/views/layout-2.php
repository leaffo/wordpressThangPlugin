...
//variable default
$out = $css = $custom_css = $unit  = '';
$x = 1;
$features_arr = $btn_link_arr = array();

$out .= '<div class="slz-list-pricing-box slz-list-block slz-list-column '.esc_attr( $data['column_class'] ).'">';
		...
		$out .= '<div class="item item-'.esc_attr( $i ).'">';
			...
			$out .= '<div class="slz-pricing-box '.' '.esc_attr( $active ).'">';
				...
				$out .= '<div class="pricing-header">';
					...
					$out .= '<div class="pricing-section pricing-price ">';
