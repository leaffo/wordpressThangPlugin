...
//custom header
$show_custom_header = $headers->get_config('show_custom_header');
$custom_header = array();
if (isset($show_custom_header) && $show_custom_header == true) {
    $option_content_header = $headers->get_config('option_content_header');
    if ( !isset($option_content_header) ) {
        $option_content_header = array();
    }
    $custom_header = array(
        'custom-header' => array(
            'type'          => 'popup',
            'label'         => esc_html__( 'Custom Header', 'slz' ),
            'desc'          => esc_html__( 'Custom left right header', 'slz' ),
            'button'        => esc_html__( 'Custom', 'slz' ),
            'size'          => 'medium',
            'popup-options' => array(
                'left-position'            => array(
                ...
                'other' => array(
                    ...
                    'label'        => false,
                    'attr'  => array(
                        'class' => 'slz-custom-header',
                        'data-foo' => 'bar',
                    ),
                    'inner-options' => array(
                        'left-content' => array(
                            'type'          => 'wp-editor',
                            'label'         => esc_html__('Header Left Content', 'slz'),
                        ...
                        'right-content' => array(
                            'type'          => 'wp-editor',
                            'label'         => esc_html__('Header Right Content', 'slz'),
