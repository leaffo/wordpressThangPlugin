...
//header full width
$fullwidth = 'container';
if( slz_akg('header-fullwidth', $options, '') == 'yes' ){
	$fullwidth = '';
}
...
?>
<header>
    <div class="slz-header-wrapper header-08 slz-header-fullwidth <?php echo esc_attr($header_class);?>">
        <?php
            ...
            <div class="slz-header-main <?php echo esc_attr($header_sticky) .' '.esc_attr($subheader_class);?>">
                <div class="<?php echo esc_attr($fullwidth)?>">
                    ...
                    <div class="slz-main-menu <?php echo esc_attr($main_menu_class); ?>">
                        ...
                        ?>
                        <?php echo slz_get_main_button($options);?>
                    </div>
