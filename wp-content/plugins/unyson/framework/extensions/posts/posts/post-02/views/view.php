...
<div class="slz-blog-detail layout-2 <?php echo esc_attr( $container_class['sidebar_layout_class'] ); ?>">
    <div class="row">
        <div class="<?php echo esc_attr( $container_class['content_class'] ); ?> col-sm-12 slz-posts slz-content-column single-posts-02">
            <?php
