...
<div class="slz-blog-detail layout-3 <?php echo esc_attr( $container_class['sidebar_layout_class'] ); ?>">
	<?php $module = new SLZ_Block_Module( get_post(), $post_instance->get_data()); ?>
    <?php $module->get_post_format_post_view(); ?>

    <div class="row">
        <div class="<?php echo esc_attr( $container_class['content_class'] ); ?> slz-posts col-sm-12 slz-content-column single-posts-03">
            <?php
