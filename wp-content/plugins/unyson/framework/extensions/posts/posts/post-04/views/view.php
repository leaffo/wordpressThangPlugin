...
<div class="slz-blog-detail layout-4 <?php echo esc_attr( $container_class['sidebar_layout_class'] ); ?>">
	...
	?>
    <div class="row">
        <div class="<?php echo esc_attr( $container_class['content_class'] ); ?> slz-posts slz-content-column single-posts-04">
            <?php
